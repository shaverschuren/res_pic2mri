...
- For each patient:
  ...
  - Preprocesses the image (optional cropping, orientation)
...
3. **Markup Annotation**: Place control points along the resection boundary
4. **Export**: Save curve control points to CSV when done
...
_[Add citation information if applicable]_
